...
/**
 * Created by arciom on 13.07.2017.
 */
...
// Don't know why it doesn't allow login at the first attempt
  ...
  private Folder openInbox(String usernsme, String password) throws MessagingException {
    store = mailSession.getStore("pop3");
    store.connect(mailserver, usernsme, password);
